...
Feature: Media
  ...
  Scenario: Image styles
    Then exactly the following image styles should exist
      ...
      | X Small landscape (480x298)        | x_small_landscape           |
      | X Small square (480x480)           | x_small_square              |
  ...
  Scenario: Image effects
    Then exactly the following image effects should exist
      ...
      | X Small landscape (480x298)        | Focal Point Scale and Crop | 480×298    |
      | X Small square (480x480)           | Focal Point Scale and Crop | 480×480    |
